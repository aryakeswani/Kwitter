...
//Start code
console.log(fire.logase_message_id);
console.log(message_data);
namee= message_data['name'];
message=message_data['like'];
name_with_tag="<hr>"+ namee +"<img class='user_tick' src='tick.png'></h4>"
message_with_tag="<h4 class='message_h4'>"+ message + "</h4>";
like_button ="<button class='btn btn-warning' id="+firebase_message_id+" value="+like+"onlcick='updateLike(this.id)'>";
span_with_tag = "<span class='glyphiocon glyphiocon-thumbs-up'> Like: " + like +"</span></button><hr>";
...
{
      console.log("click on like buttom - " + message_id);
